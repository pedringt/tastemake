...
**State**
- `main` = `d3047e9` (PR #66). **`live-producer-preview` is three commits ahead** (`477a26d` #59 items 4/5, `1dfb5c4` the #28 JSON-parsing fix, `bad8353` #67 overlap fix + #29/#68 Bookmarks visibility), all verified via clean CI, **not yet promoted** — merge when Paige is ready.
