    ...
    <section class="profile-screen">
      ...
      <div class="profile-hero">
        <div class="profile-title-block">
          ...
          ${state.hypothesisAiMessage ? `<div class="profile-ai-status" role="status"><span>${esc(state.hypothesisAiMessage)}</span>${!liveProfile && state.hypothesisAiStatus !== "loading" ? `<button class="button button-quiet profile-retry" type="button" data-action="retry-profile">Retry profile AI</button>` : ""}</div>` : ""}
