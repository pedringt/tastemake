...
// knows, never stored separately, so it cannot disagree with Library (Saved/Tried), Taste Profile or Map.
// Two groups, because they mean different things:
//   counts as taste   Favorites, Loved it, Liked it, Tried it and disliked
//   only steers       plain More / Less on untried picks, Not interested, Saved (untried) saves
...
function statusOf(feedback) {
  ...
  if (isSaved(feedback)) return "Saved (haven't tried)";
